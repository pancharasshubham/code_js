...
- const allH2 = document.querySelectorAll('h2')   //  undefined

- allH2[0].innerText              // many times first value not start with 0
=> ''                             // command gives you empty array                                  
...
- const myBody = document.querySelectorAll('.mw-body-content')    // undefined
